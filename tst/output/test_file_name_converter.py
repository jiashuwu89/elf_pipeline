...
class TestFileNameConverter:
    ...
    def test_convert(self):
        ...
        assert dest_1 == "/themis/data/elfin/ela/1/eng/ela_l1_eng_20000101_v01.cdf"

        # State names must be handled differently
        fname_2 = "/usr/bin/elb_l1_state_defn_20200901_v01.cdf"
        dest_2 = fnc.convert(fname_2)
        assert dest_2 == "/themis/data/elfin/elb/1/state/defn/elb_l1_state_defn_20200901_v01.cdf"
